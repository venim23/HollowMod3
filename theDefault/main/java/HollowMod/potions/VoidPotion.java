...
public class VoidPotion extends AbstractPotion {


    public static final String POTION_ID = hollowMod.makeID("VoidPotion");
    ...
    public VoidPotion() {
        ...
        super(NAME, POTION_ID, PotionRarity.UNCOMMON, PotionSize.M, PotionColor.FEAR);
    ...
    public void use(AbstractCreature target) {
        ...
        if (AbstractDungeon.getCurrRoom().phase == AbstractRoom.RoomPhase.COMBAT) {
            ...
            AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(target, target, new VoidPower(target, potency),potency));
            if (target.hasPower(SoulPower.POWER_ID)){
                AbstractDungeon.actionManager.addToBottom(new RemoveSpecificPowerAction(target, target, SoulPower.POWER_ID ));
            }
        }
    }
