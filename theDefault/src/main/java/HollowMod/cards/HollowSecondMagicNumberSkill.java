...
public class HollowSecondMagicNumberSkill extends AbstractHollowCard {
    ...
    public static final String ID = hollowMod.makeID("HollowSecondMagicNumberSkill");
    ...
    public HollowSecondMagicNumberSkill() {
