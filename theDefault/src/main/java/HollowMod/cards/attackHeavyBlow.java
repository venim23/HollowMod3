...
public class attackHeavyBlow extends AbstractDefaultCard {
    ...
    public static final String ID = hollowMod.makeID("HeavyBlow");
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);

    public static final String IMG = makeCardPath("attackHeavyBlow.png");
    ...
    public attackHeavyBlow() {// This one and the one right under the imports are the most important ones, don't forget them
