...
public class attackZoteling extends AbstractHollowCard {
    ...
    public static final String ID = hollowMod.makeID("NewZoteling"); // DefaultMod.makeID("attackDashSlash");
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);

    public static final String IMG = makeCardPath("attackZoteling.png");// "public static final String IMG = makeCardPath("attackDashSlash.png");
    ...
    private static final int DAMAGE = 1;    // DAMAGE = 7
    private static final int UPGRADE_PLUS_DMG = 1;
    private static final int CARDS = 1;// UPGRADE_PLUS_DMG = 2

    // /STAT DECLARATION/


    public attackZoteling() {// This one and the one right under the imports are the most important ones, don't forget them
