...
public class attackFastStrike extends AbstractDefaultCard {
    ...
    public static final String ID = hollowMod.makeID("FastStrike");
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);

    public static final String IMG = makeCardPath("attackFastStrike.png");
    ...
    private static final int UPGRADE_PLUS_ENEMIES = 1;
    ...
    public void upgrade() {
        if (!upgraded) {
            ...
            upgradeMagicNumber(UPGRADE_PLUS_ENEMIES);
