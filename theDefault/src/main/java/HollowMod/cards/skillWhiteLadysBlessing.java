...
public class skillWhiteLadysBlessing extends AbstractHollowCard {
    ...
    public static final String IMG = makeCardPath("skillWhiteLadysBlessing.png");// "public static final String IMG = makeCardPath("skillQuickDash_s.png");
    ...
    public skillWhiteLadysBlessing() {// This one and the one right under the imports are the most important ones, don't forget them
