...
public class attackGreatSlash extends AbstractDefaultCard {
    ...
    public static final String ID = hollowMod.makeID("GreatSlash");
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);

    public static final String IMG = makeCardPath("attackGreatSlash.png");
    ...
    public attackGreatSlash() {// This one and the one right under the imports are the most important ones, don't forget them
        super(ID, NAME, IMG, COST, DESCRIPTION, TYPE, COLOR, RARITY, TARGET);
        baseDamage = DAMAGE;

        magicNumber = baseMagicNumber = TIMES_HIT;
    ...
    public void upgrade() {
        if (!upgraded) {
            upgradeName();
            upgradeMagicNumber(UPGRADE_PLUS_TIMES_HIT);
