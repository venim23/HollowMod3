...
public class attackNestling extends AbstractHollowCard {
    ...
    public static final String ID = hollowMod.makeID("NewNestling"); // DefaultMod.makeID("attackDashSlash");
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);

    public static final String IMG = makeCardPath("attackNestling.png");// "public static final String IMG = makeCardPath("attackDashSlash.png");
    ...
    public attackNestling() {// This one and the one right under the imports are the most important ones, don't forget them
