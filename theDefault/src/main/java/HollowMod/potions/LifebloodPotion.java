...
public class LifebloodPotion extends AbstractPotion {
    ...
    public static final String POTION_ID = hollowMod.makeID("LifebloodPotion");
    ...
    public void use(AbstractCreature target) {
        ...
        if (AbstractDungeon.getCurrRoom().phase == AbstractRoom.RoomPhase.COMBAT) {
            AbstractDungeon.actionManager.addToBottom(new AddTemporaryHPAction(target, target, potency));
