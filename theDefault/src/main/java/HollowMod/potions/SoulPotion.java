...
public class SoulPotion extends AbstractPotion {


    public static final String POTION_ID = hollowMod.makeID("SoulPotion");
    ...
    public void use(AbstractCreature target) {
        ...
        if (AbstractDungeon.getCurrRoom().phase == AbstractRoom.RoomPhase.COMBAT) {
            if (!target.hasPower(VoidPower.POWER_ID)) {
                AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(target, target, new SoulPower(target, potency), potency));
            }
