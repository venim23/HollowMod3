...
public class monsterViolentHusk extends AbstractMonster {
    ...
    public static final String ID = hollowMod.makeID("ViolentHusk");
	...
	*/
        super(monsterViolentHusk.NAME, ID, 375, 0.0F, 0.0F, 200.0F, 300.0F, null, xOffset, 0.0F);
        ...
        loadAnimation(
                //loads the animation
                hollowMod.makeMonsterPath("violenthusk/ViolentHusk.atlas"),
                hollowMod.makeMonsterPath("violenthusk/ViolentHusk.json"), 0.7F);
