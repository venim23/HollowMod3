...
public class WeaverSongPower extends AbstractPower implements CloneablePowerInterface {
    public AbstractCreature source;

    public static final String POWER_ID = hollowMod.makeID("WeaverSongPower");
    ...
    private static final Texture tex84 = TextureLoader.getTexture(makePowerPath("weaversong_power84.png"));
    private static final Texture tex32 = TextureLoader.getTexture(makePowerPath("weaversong_power32.png"));
    //public static int ElderbugDrawInt = 1;

    public WeaverSongPower(final AbstractCreature owner, final AbstractCreature source, final int amount) {
        name = NAME;
        ID = POWER_ID;
    ...
    public AbstractPower makeCopy() {
        return new WeaverSongPower(owner, source, amount);
    }
}
